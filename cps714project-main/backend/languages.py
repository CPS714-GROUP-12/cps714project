...
class Language:
    ...
    def add_new_language(self, language):
        ...
        for row in PhraseCodeName.query.all():
            ...
            newPhrase = Phrases(phrase_code=row.phrase_code, language_code=language_code,phrase_translated=translated, user_id=user_id )
            newPhrase.save()
    ...
    def add_new_phrase(self, phrase, user_id=None):
        ...
        for row in LanguageCodeName.query.all():
            if (row.language_name != "english"):
                ...
                newPhrase = Phrases(phrase_code = my_phrase_code, language_code = row.language_code, user_id = user_id, phrase_translated = translated)
