...
class Users(db.Model):
    ...
    created_on = db.Column(db.DateTime(timezone=True),
                           server_default=func.now())  # https://stackoverflow.com/questions/13370317/sqlalchemy-default-datetime
...
class RestaurantReviewsImages(db.Model):
    ...
    review_id = db.Column(db.Integer(), db.ForeignKey("restaurant_reviews.review_id", ondelete="CASCADE"),
                          nullable=False)
